...
count = 0
def drive(cfg, model_path=None, use_joystick=False, model_type=None, camera_type='single', meta=[],aa=4):
    '''
    ...
    class DriveMode:
        def run(self, mode, 
            ...
            if count < 6:
                ...
                return pilot_angle, pilot_throttle * cfg.AI_THROTTLE_MULT - 0.1
...
if __name__ == '__main__':
    ...
    if args['drive']:
        ...
        #with open(r'','r',encoding='utf-8') as ff:
        #	lines=[]
        #	for line in ff.readlines():
        #		if line!='\n':
        #			lines.append(line.strip('\n'))
        #			if line == '1':
        #				drive(cfg, model_path='/models/mypliot.h5')
        #			elif line == '2':
        #				drive(cfg,model_path='/models/mypilot01.h5')

        drive(cfg, model_path='/models/enhance02.h5', use_joystick=args['--js'], model_type=model_type, camera_type=camera_type,
            meta=args['--meta'])
